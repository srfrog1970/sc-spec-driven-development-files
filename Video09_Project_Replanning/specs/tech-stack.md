...
| CSS | Plain CSS + CSS custom properties + media queries | No build step required; delivers a responsive, mobile-friendly layout; Steve gets a modern, attractive result on any screen size |
